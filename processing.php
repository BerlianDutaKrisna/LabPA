                ...
                <div class="container-fluid">
                    ...
                    <div class="card-header py-3">
                                <div class="row">
                                    ...
                                    <div class="m-3">
                                        <a disabled href="processing.php" class="btn btn-secondary disabled btn-icon-split btn-lg">
                                        <span class="icon text-white-50">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <i class="fas fa-pause"></i> Selesai proses
                                            </button>
                                        </div>                    
                                    </div>
                                        ...
                                        <div class="form-group col-12">
                                            ...
                                            <i class="fas fa-undo-alt"></i> Kembalikan memotong
                                            </button>
                                        </div>
                                    </form>   
                                </div>
