                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <label class="mb-2">Kode HPA</label>
                                        <input type="text" name="kode_hpa" value="<?=$DATA_HPA["kode_hpa"];?>" class="form-control form-control-user" autocomplete="off" >
                                    </div>
                                    <div class="form-group col-2 mw-100">
                                    <label class="mb-2">Diagnosis</label>
                                        <input type="text" name="diagnosis_hpa" value="<?=$DATA_HPA["diagnosis_hpa"];?>" class="form-control form-control-user" autocomplete="off" >
                                    </div>
                                    <div class="form-group col-3 mw-100">
                                    ...
                                    <div class="form-group col-2 mw-100">
                                        <label class="mb-2">Tangal Blangko Sampel</label>
                                            <input type="date" name="tgl_hpa" value="<?=$DATA_HPA["tgl_hpa"];?>" class="form-control form-control-user" autocomplete="off">
                                        </div>
                                        <div class="form-group col-2 mw-100">
                                ...
                                <select name="jumlah_kaset" class="form-control form-control-user" autocomplete="off">
                                    <option selected value="<?=$DATA_HPA["jumlah_kaset"];?>"><?=$DATA_HPA["jumlah_kaset"];?></option>
                                ...
                                <textarea <?php echo $isFromReading || $isFromIndex ? '' : 'readonly'; ?> type="text" name="mikroskopis_hpa" class="form-control form-control-user" autocomplete="off"><?=$DATA_HPA["mikroskopis_hpa"];?></textarea>
                                </div>
                                <div class="form-group col-6 mw-100">
                                <label class="mb-2">Hasil HPA</label>
                                    <input <?php echo $isFromReading || $isFromIndex ? '' : 'readonly'; ?> type="text" name="hasil_hpa" value="<?=$DATA_HPA["hasil_hpa"];?>" class="form-control form-control-user" autocomplete="off">
                                </div>
                                ...
                                <div class="form-group col-3">
                                    <label class="mb-2">Kualitas Sediaan</label>
                                        <input type="number" name="kualitas_sediaan" value="<?=$DATA_HPA["kualitas_sediaan"];?>" class="form-control form-control-user" autocomplete="off" >
                                    </div>
                                <div class="row">
                                    <div class="form-group col-3 mw-100">
                                        <a href="<?php echo $isFromReading ? 'reading.php' : ($isFromIndex ? 'index.php' : 'grossing.php');?>" class="btn btn-warning btn-user btn-block">
