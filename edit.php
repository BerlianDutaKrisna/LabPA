...
$pasien = query("SELECT * FROM histopadata WHERE id = $id")[0];
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Main Content -->
                ...
                <div class="container">
                    ...
                    <input type="hidden" name="fotolama" id="fotolama" value="<?=$pasien["foto"];?>">
                        Nomer Rekamedis
                        <div class="form-group row">
                            <div class="col-sm-3 mb-3 mb-sm-0">
                                <input type="text" name="norm" id="norm" required class="form-control form-control-user" 
                                    value="<?=$pasien["norm"];?>">
                            </div>
                        </div>
                        Nama Pasien
                        ...
                        <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="text" name="tgllahir" id=" tgllahir" class="form-control form-control-user" 
                                    value="<?=$pasien["tgllahir"];?>">
                            </div>
                        </div>
                        Alamat
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                            <img src="img/<?= $pasien["foto"];?>" width="40" alt="">
                            <br>
