                ...
                <div class="container-fluid">
                    ...
                    <div class="card-header py-3">
                                <div class="row">
                                    ...
                                    <div class="m-3">
                                        <a disabled href="slicing.php" class="btn disabled btn-secondary btn-icon-split btn-lg">
                                        <span class="icon text-white-50">
