...
if(isset($_POST["btn_tambah_pasien"])) {
    $tambahdata = tambah_pasien($_POST);
}
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- Main Content -->
                ...
                <div class="container-fluid">
                    <div>
                        <h1 class="h4 text-gray-900 mb-4">Tambah Data Pasien</h1>
                    </div>
  
                        <div class="card shadow mb-4">
                        <div class="card-header py-4">
                                <h6 class="m-0 font-weight-bold text-primary">Tambah Data Pasein</h6>
                            </div>
                            <div class="card-body">
                                <label class="mb-2">Nomer Rekamedis</label>
                                <form action="hasil_pencarian.php" method="post" >
                                    <div class="input-group col-3 mb-5">
                                        <input type="text" name="input_norm" class="form-control bg-light border-0 small" 
                                         placeholder="Pecarian nomer rekamedis pasien" autofocus autocomplete="off">
                                        <div class="input-group-append">
                                ...
                                <label class="mb-2">No Rekamedis Baru</label>
                                ...
                                <textarea type="text" name="alamat_pasien" class="form-control form-control-user" autocomplete="off"></textarea>
                                </div>
                                <div class="form-group col-6">
                                <label class="mb-2">Jenis Kelamin</label>
                                <select name="jk_pasien" class="form-control form-control-user" autocomplete="off">
                                ...
                                <label class="mb-2">Tanggal Lahir</label>
                                    <input type="date" name="tgl_lahir_pasien" class="form-control form-control-user" autocomplete="off">
                                </div>
                                <div class="form-group col-6">
                                <label class="mb-2">Status Pasien</label>
                                <select name="status_pasien" class="form-control form-control-user" autocomplete="off">
                                    <option selected value="PBI">PBI</option>
